---
layout: default
title: "Lab 9-a: Azure Service Bus – Geo-Disaster Recovery"
---

[**Lab 9-a: Azure Service Bus – Geo-Disaster Recovery**](./lab-09a-service-bus-geo-dr.md) | [Lab 9-b: Azure Service Bus – Private Networking](./lab-09b-service-bus-private-networking.md)

# Lab 9-a: Azure Service Bus – Geo-Disaster Recovery
...
> **Variant note:** This `A` variant keeps the original public-endpoint Geo-DR workflow. If you already completed Lab 0 and want Service Bus namespace plus alias access over private endpoints in the spoke VNets, continue with [Lab 9-b: Azure Service Bus – Private Networking](./lab-09b-service-bus-private-networking.md).
