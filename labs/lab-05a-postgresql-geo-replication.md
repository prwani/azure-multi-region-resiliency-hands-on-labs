---
layout: default
title: "Lab 5-a: Azure Database for PostgreSQL – Cross-Region Read Replica"
---

[Lab 5-a — PostgreSQL Geo-Replication](lab-05a-postgresql-geo-replication.md) | [Next: Lab 5-b — Private PostgreSQL Geo-Replication →](lab-05b-postgresql-private-geo-replication.md)

# Lab 5-a: Azure Database for PostgreSQL – Cross-Region Read Replica
...
<div class="lab-note">
<strong>Variant A:</strong> This path preserves the original PostgreSQL geo-replication lab in its simpler public-access form and does <strong>not</strong> depend on Lab 0. If you want the secured version that reuses the Lab 0 spoke networks and private endpoints, continue to <strong>Lab 5-b</strong>.
</div>
...
[Continue to Lab 5-b: Private PostgreSQL Geo-Replication →](lab-05b-postgresql-private-geo-replication.md)
