---
layout: default
title: "Lab 12-a: Baseline AKS Multi-Cluster – Global Routing with Fleet, ACR, and Front Door"
---

[Lab 12-b: Hub-and-Spoke Variant →](lab-12b-aks-multi-cluster-hub-spoke.md)

# Lab 12-a: Baseline AKS Multi-Cluster – Global Routing with Fleet, ACR, and Front Door

This is the baseline **public-edge** variant of the AKS multi-cluster lab. It keeps the current Fleet + geo-replicated ACR + Azure Front Door flow and uses direct regional public ingress so you can focus on the multi-cluster control pattern first. If you want the spoke-based version that assumes the Lab 0 network foundation and moves the clusters behind the regional hub security baseline, continue to **Lab 12-b**.
...
[Continue to Lab 12-b: Hub-and-Spoke Variant →](lab-12b-aks-multi-cluster-hub-spoke.md)
