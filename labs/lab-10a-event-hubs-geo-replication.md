---
layout: default
title: "Lab 10-a: Azure Event Hubs – Geo-Replication Failover"
---

**Lab 10-a: Azure Event Hubs – Geo-Replication Failover** | [Lab 10-b: Azure Event Hubs – Private Networking →](lab-10b-event-hubs-private-networking.md)

# Lab 10-a: Azure Event Hubs – Geo-Replication Failover
...
with producer:
    ...
    producer.send_batch(batch)
    print("Sent 10 pre-failover events through the alias")
'@ | Set-Content -Path "./send_events.py"
...
with producer:
    ...
    producer.send_batch(batch)
    print("Sent 10 post-failover events through the same alias")
'@ | Set-Content -Path "./send_events_post_failover.py"

python ./send_events_post_failover.py
```
