---
layout: default
title: "Lab 2-a: Azure SQL Database – Geo-Replication &amp; Failover"
---

**Lab 2-a: Azure SQL Database – Geo-Replication & Failover** | [Lab 2-b: Azure SQL Database – Private Geo-Replication & Failover](./lab-02b-sql-private-geo-replication.md)

# Lab 2-a: Azure SQL Database – Geo-Replication & Failover
...
<div class="lab-note">
<strong>Variant note:</strong> Lab 2-a preserves the current public-endpoint SQL lab in spirit. If you already completed Lab 0 and want the same geo-replication/failover flow over <strong>private endpoints and private DNS</strong> from the spoke VNets, use <a href="./lab-02b-sql-private-geo-replication.md">Lab 2-b</a>.
</div>
...
> **Tip:** If you completed any earlier lab in the series, you already have the CLI and subscription context ready.
...
Save the shared SQL above as `lab2a-setup.sql`, then run:
...
```powershell
$SetupSqlPath = Join-Path $env:TEMP "lab2a-setup.sql"
