---
layout: default
title: "Lab 13-a: Azure Data Factory – Active/Passive Data Pipelines"
---

[Lab 13-b: Azure Data Factory Private Networking →](lab-13b-data-factory-private-networking.md)

# Lab 13-a: Azure Data Factory – Active/Passive Data Pipelines
...
> **Objective:** Build the simpler `A` variant of the Azure Data Factory disaster-recovery lab: keep a public HTTP source, create primary and secondary factories, and practice the manual active/passive failover workflow.

<div class="lab-note">
<strong>Variant note:</strong> This <code>A</code> path stays close to the original Data Factory lab and does <strong>not</strong> require Lab 0. If you want private endpoints and spoke-based connectivity, continue to <a href="lab-13b-data-factory-private-networking.md">Lab 13-b</a>.
</div>
...
| Azure SQL source? | Use geo-replication and point the secondary linked service to the secondary server. |
| Blob Storage source? | Use object replication and point the secondary linked service to the replica account. |
