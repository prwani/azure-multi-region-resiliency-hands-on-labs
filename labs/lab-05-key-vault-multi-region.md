---
layout: default
title: "Lab 8: Azure Key Vault – Multi-Region Backup & Sync"
---

[← Back to Index](../index.md)

# Lab 8: Azure Key Vault – Multi-Region Backup & Sync
...
> **Objective:** Deploy Azure Key Vaults in two regions, populate the primary vault with secrets, keys, and certificates, then seed a secondary vault by using backup/restore for non-exportable material and an optional sync script for secrets.
...
```powershell
$DefaultPolicyFile = Join-Path ([System.IO.Path]::GetTempPath()) "kv-appcert-policy.json"
...
```powershell
$DefaultPolicyFile = Join-Path ([System.IO.Path]::GetTempPath()) "kv-secondary-appcert-policy.json"
...
[← Back to Index](../index.md) | [Next: Lab 9 — Azure Service Bus Geo-DR →](lab-06-service-bus-geo-dr.md)
