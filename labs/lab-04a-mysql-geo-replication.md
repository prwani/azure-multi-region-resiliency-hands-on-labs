---
layout: default
title: "Lab 4-a: Azure Database for MySQL – Public Cross-Region Read Replica"
---

[Lab 4-b: Private networking variant →](lab-04b-mysql-private-geo-replication.md)

# Lab 4-a: Azure Database for MySQL – Public Cross-Region Read Replica

> **Variant note:** Lab 4-a keeps the original public-access lab flow. If you want the secure hub-and-spoke path that assumes Lab 0, continue with [Lab 4-b](lab-04b-mysql-private-geo-replication.md).
...
Azure Database for MySQL Flexible Server is the recommended deployment option for MySQL workloads on Azure. **Lab 4-a keeps the original public-access workflow**: you create a source server, seed sample data, add a cross-region read replica, validate replication, and promote the replica during a failover drill. Unlike Azure SQL Database, MySQL Flexible Server does not offer built-in Failover Groups with automatic DNS switching. Instead, it provides **cross-region read replicas** using MySQL's native asynchronous binary log (binlog) replication.
...
[Lab 4-a](lab-04a-mysql-geo-replication.md) | [Lab 4-b: Private networking variant →](lab-04b-mysql-private-geo-replication.md)
